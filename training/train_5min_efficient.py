"""
Efficient 5-Minute Horizon Training Script
=========================================
...
class EfficientFiveMinuteTrainer:
    """
    Efficient trainer for 5-minute prediction horizon with practical training times.
    """
    
    def __init__(self):
        """Initialize the efficient 5-minute horizon trainer."""
        self.horizon = 5
        self.datasets_dir = Path(__file__).parent.parent / 'backend' / 'training' / 'time_series_datasets'
        self.output_dir = Path(__file__).parent.parent / 'backend' / 'trained_models' / '5min_efficient'
        self.output_dir.mkdir(parents=True, exist_ok=True)
        
        # Checkpoint directory
        self.checkpoint_dir = Path('checkpoints_5min_efficient')
        ...
        logger.info(f"Efficient 5-Minute Trainer initialized")
    ...
    def create_visualizations(self, results, y_test):
        ...
        fig.suptitle(f'Efficient 5-Minute Horizon Model Performance Analysis', fontsize=16, fontweight='bold')
        ...
        viz_path = analysis_viz_dir / '5min_efficient_model_performance.png'
    ...
    def save_best_model(self, results, best_model_name):
        ...
        with open(summary_path, 'w') as f:
            f.write(f"Efficient 5min Horizon Training Summary\n")
            f.write(f"==================================================\n\n")
    ...
    def print_summary(self, results, best_model_name):
        ...
        logger.info("-" * 40)
        logger.info("Previous 5min Results: R² = -0.0907, RMSE = 10.8254")
        ...
        logger.info(f"   • Visualization: {Path(__file__).parent.parent}/analysis_visualizations/5min_efficient_model_performance.png")
    ...
    def run_training(self):
        ...
        """
        try:
            logger.info("🚀 Starting efficient 5-minute horizon training...")
            logger.info("=" * 60)
            ...
            logger.info("=" * 60)
            logger.info("🎉 Efficient 5-minute horizon training completed!")
...
if __name__ == "__main__":
    trainer = EfficientFiveMinuteTrainer()
